...
#  All models have sex and birth year (by_cat) as a covariate
...
ytime1 ~ 0*1 + sex + by_cat
ytime2 ~ 0*1 + sex + by_cat
ytime3 ~ 0*1 + sex + by_cat
...
i1 ~~ s1
#Obs variable intercepts (fixed to 0)
ytime1 ~ 0*1 + adj_pgs + sex + by_cat
ytime2 ~ 0*1 + adj_pgs + sex + by_cat
ytime3 ~ 0*1 + adj_pgs + sex + by_cat
#Growth parameter intercepts (freely estimated)
i1 ~ 1 
s1 ~ 1 
'
...
####define growth models with constrained covariates as suggested under review
...
i1 ~~ s1
#Obs variable intercepts (fixed to 0)
ytime1 ~ 0*1 + b1*sex + b4*by_cat
ytime2 ~ 0*1 + b2*sex + b5*by_cat
ytime3 ~ 0*1 + b3*sex + b6*by_cat
#Growth parameter intercepts (freely estimated)
i1 ~ 1 
s1 ~ 1 
'

# Basic  LGM + pgs on residuals
...
i1 ~~ s1
#Obs variable intercepts (fixed to 0)
ytime1 ~ 0*1 + adj_pgs + b1*sex + b4*by_cat
ytime2 ~ 0*1 + adj_pgs + b2*sex + b5*by_cat
ytime3 ~ 0*1 + adj_pgs + b3*sex + b6*by_cat
#Growth parameter intercepts (freely estimated)
i1 ~ 1 
s1 ~ 1 
'
